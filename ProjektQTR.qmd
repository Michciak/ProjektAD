...
W pobliżu `Paltform` widzimy takie konsole jak `GBA`,`NES`,`Wii`,`WiiU` są to produkty Nintendo, które jest znane z gier platformowych takich jak np. *Mario* pełniących rolę gier eksluzywnych (gier na wyłączność dla danej platformy/producenta platformy). 
